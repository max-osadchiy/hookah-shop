  ...
  const arrayInputs = [
    {
      ...
      type: 'text',
      onChange: (e) => mainStore.onChangeInput('customerFirstname', e.target.value),
    },
    {
      name: 'lastName',
      ...
      type: 'text',
      onChange: (e) => mainStore.onChangeInput('customerLastname', e.target.value),
    },
    {
      name: 'email',
    ...
    },
    {
      ...
      type: 'text',
      onChange: (e) => mainStore.onChangeInput('customerPostOffice', e.target.value),
    },
  ];
      ...
      <div>
        {arrayInputs.map((input) => (
          <div>
            ...
            <input name={input.name} value={input.value} onChange={input.onChange} type={input.type}/>
          </div>
        ))}
        <button disabled={disableList.includes("") || mainStore.isLoadingForm} onClick={() => mainStore.orderItems()}>{t('buttons.order')}</button>
      </div>
    </div>
  </Modal>
  );
